...
const seedTickets: WorkoutTicket[] = [
  {
    id: 'social-seed-1',
    sourceWorkoutId: 'seed-1',
    visibility: 'social',
    routineName: 'Pull',
    completedAt: 'Hoy · 6:10 AM',
    durationMinutes: 58,
    volumeKg: 7640,
    photo: 'mock',
    signedByAuthor: true,
  ...
  {
    id: 'private-seed-1',
    sourceWorkoutId: 'seed-2',
    visibility: 'private',
    routineName: 'Push',
    completedAt: 'Ayer · 7:42 AM',
    durationMinutes: 64,
    volumeKg: 8420,
    photo: 'mock',
    signedByAuthor: true,
  ...
  {
    id: 'private-seed-2',
    sourceWorkoutId: 'seed-3',
    visibility: 'private',
    routineName: 'Legs',
    completedAt: 'Vie · 6:28 PM',
    durationMinutes: 71,
    volumeKg: 10680,
    photo: 'mock',
    signedByAuthor: true,
...
export const useTicketMockStore = create<TicketMockState>((set, get) => ({
  ...
  publishWorkout: (routine, durationMinutes, sets) => {
    ...
    const volume = Object.values(sets)
      .flat()
      .reduce((total, item) => total + item.weightKg * item.reps, 0)
    const now = new Date()
    ...
    const privateTicket: WorkoutTicket = {
      ...base,
      id: `${sourceWorkoutId}-private`,
      visibility: 'private',
      circles: [],
    }
