  ...
  return (
    <SafeAreaView className='flex-1 bg-surface' edges={['top', 'left', 'right']}>
      <ScrollView contentContainerStyle={{ padding: 20, paddingBottom: 40 }}>
        ...
        <Text className='mt-7 font-geist-mono-semibold text-3xl tracking-[-1px] text-surface-dark'>Mis círculos</Text>
        <Text className='mt-3 font-geist-mono text-xs leading-5 text-ink-muted'>Al cerrar un ticket grupal, se publica automáticamente en todos estos círculos.</Text>
