...
export default function NewCircleScreen() {
  ...
  return (
    <SafeAreaView className='flex-1 bg-surface p-5' edges={['top', 'left', 'right']}>
      ...
      <Text className='mt-8 font-geist-mono-semibold text-3xl uppercase tracking-[-1px] text-surface-dark'>Nuevo círculo</Text>
      <Text className='mt-2 font-geist-mono text-xs uppercase leading-5 tracking-tight text-ink-muted'>Las personas que agregues recibirán tus tickets grupales.</Text>
