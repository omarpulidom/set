      ...
      <ScrollView contentContainerStyle={{ padding: 20, paddingBottom: 40 }}>
        ...
        <View className='mt-6 rounded-3xl bg-surface-muted p-5'>
          <View className='flex-row border-t border-border-soft pt-4'>
            <View className='flex-1'><Text className='font-geist-mono text-[10px] text-ink-muted'>DURACIÓN</Text><Text className='mt-1 font-geist-mono-semibold text-sm text-surface-dark'>{ticket.durationMinutes} min</Text></View>
            <View className='flex-1 border-l border-border-soft pl-4'><Text className='font-geist-mono text-[10px] text-ink-muted'>FIRMA</Text><Text className='mt-1 font-geist-mono-semibold text-sm text-surface-dark'>{ticket.signedByAuthor ? 'Confirmada' : 'Pendiente'}</Text></View>
          </View>
          <Text className='mt-5 font-geist-mono text-xs leading-5 text-ink-muted'>Aquí irá el diseño final del ticket, sus datos de series, peso, foto y composición visual.</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  )
